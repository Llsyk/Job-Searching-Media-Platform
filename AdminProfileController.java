    ...
    public String updateAdminProfile(
        ...
        if (newPassword != null && !newPassword.isEmpty()) {
            ...
            if (passwordEncoder.matches(currentPassword, admin.getPassword())) {
                ...
                // Add error message to model and return to the same page
                model.addAttribute("currentPasswordError", "Current password is incorrect.");
                model.addAttribute("admin", admin); // Ensure the form remains populated with the user's info
            }
        }
        ...
        // Add updated admin details to model and redirect to profile page
        model.addAttribute("admin", admin);
    ...
    public String uploadPhoto(@ModelAttribute("admin") Admin admin,
        ...
        if (!file.isEmpty()) {
            try {
                ...
                String uploadDir = "D:\\Servelt\\Final_JN\\webcontent\\resources\\Upload_image\\"; // Set your upload directory path
        ...
        return "redirect:/adminprofile"; // Return to the profile page with the updated data
    }
